      ...
      <section class="w-full px-3 mt-8 mb-5">
        <div class="w-full">
          <div class="breadcrumb">
            @include('backend.sbreadcrumb.navigations.edit')
          </div>

          <form action="
            {{ route('navigations.update', $navigation->url) }}"
            method="POST">
            @method('PATCH')
            @csrf
            ...
            <div class="x-border">
              ...
              <div class="gap-8 xl:gap-14 max-auto md:flex">
                ...
                <x-input
                  ...
                  name="routee"
                  value-old="routee"
                  :value-default="$navigation->routee"
                  error="routee"
              ...
              <div class="gap-8 xl:gap-14 max-auto md:flex">
                <x-input
                  ...
                  :value-default="$navigation->button_name"
                  error="button_name"
                ...
                <x-input-textarea
                  ...
                  :value-default="$navigation->description"
                  error="description"
