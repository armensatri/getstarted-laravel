<a href="{{ $route }}"
  ...
  flex items-center p-2 hover:bg-gradient-to-r hover:via-red-100 hover:from-gray-50 hover:to-green-100 hover:rounded-full">
  ...
  <span class="ml-1 text-base font-normal tracking-wide text-blue-600">
    {{ $subMenu }}
  </span>
